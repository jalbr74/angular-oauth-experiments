...
const OAUTH_SETTINGS = {
    ...
    redirectUri: "http://localhost:4200/oauth-experiments/manual",
};
...
@Component({
    selector: 'app-automatic-oauth-steps',
    templateUrl: './automatic-oauth-steps.component.html',
    styleUrls: ['./automatic-oauth-steps.component.scss'],
})
export class AutomaticOauthStepsComponent implements OnDestroy {
